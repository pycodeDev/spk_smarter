                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-header">
                            Tambah Data Produk Masuk <strong><?php echo $produk[0]['nama_suku_cadang'] ?></strong>
                        </div>
                        <form method="POST" action="/produk_masuk/<?php echo $produk[0]['nomor_suku_cadang'] ?>">
                            <div class="card-body">
                                <?= csrf_field(); ?>
                            ...
                            <div class="card-footer text-muted">
                                ...
                                <a href="/produk_masuk/detail/<?php echo $produk[0]['nomor_suku_cadang'] ?>" class="btn btn-danger">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
